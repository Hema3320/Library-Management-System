...
# Variables
lf_bg = '#FAFAD2'  # Left Frame Background Color
rtf_bg = '#FFF8DC'  # Right Top Frame Background Color
rbf_bg = '#FFEBCD'  # Right Bottom Frame Background Color
btn_hlb_bg = '#FFD700'  # Background color for Head Labels and Buttons
